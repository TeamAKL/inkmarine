              ...
              <div class="card-body">
                <form action="{{url('company')}}" method="post">
                  ...
                  <div class="form-group row">
                    ...
                    <input type="text" class="form-control col-md-6" id="name" name="name" placeholder="Enter Company Name">
                  </div>
                  <div class="form-group row">
                    <label for="country" class="col-md-4 col-form-label" style="padding-left:12%;">Country :</label>
                    <input type="text" class="form-control col-md-6" id="country" name="country" placeholder="Country">
                  </div>
