<template>
	...
	<div>
							...
							<table class="table table-hover">
								...
								<tbody>
									<tr :key="other_company.id" v-for="other_company in othercompanies">
										...
										<td>{{other_company.grt}}</td>
										<td>{{other_company.kw}}</td>
		...
		<modal name="other_company" :clickToClose="false" height="auto" class="company_career_modal" style="overflow-y:auto;">
			<div class="modal-content">
				<div class="modal-header">
...
.medical_checkup,.certificate_modal,.appointment_info_modal,.apply_disembarkation_modal,
.additional_info,.personal_detail,.disease_modal,.accident_modal,.injury_modal,.company_career_modal,.crew_evaluate_modal
{
	overflow-y: auto;
}
.certificate-image {
